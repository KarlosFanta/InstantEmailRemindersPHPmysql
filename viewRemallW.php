...
$opts['fdd']['RemSubj'] = array(
  'name'     => 'RemSubj',
  'select'   => 'T',
  'maxlen'   => 255,
  'sort'     => true
);
$opts['fdd']['RemBody'] = array(
  'name'     => 'RemBody',
  'select'   => 'T',
  'maxlen'   => 65535,
  'textarea' => array(
...
$opts['fdd']['Time1'] = array(
  'name'     => 'Time1',
  'select'   => 'T',
  'maxlen'   => 5,
  'sort'     => true
);
$opts['fdd']['WeekDay'] = array(
  'name'     => 'WeekDay',
  'select'   => 'T',
  'maxlen'   => 1,
  'sort'     => true
...
<?php
$query = "select * from weeklyevents";
//echo $query;
...
echo "<th>".$row["WeekDay"]."</th>";//CustLN is case senSitiVe
