...
//$queryUU = "SELECT Time1 FROM eventsOnceOff";
//SUBSTRING(that_column, 1, CHAR_LENGTH(that_column) - 2) AS that_column_trimmed
//$queryUU = "UPDATE eventsOnceOff SET Time1 =concat(left(Time1,length(field) -5),'7') ";

/*
$queryUU = "UPDATE eventsOnceOff IF (LEFT(Time1,4) = '0') THEN
 SET Time1 = CONCAT( LEFT(Time1,4), '2')
ELSEIF (LEFT(Time1,4) = '1') THEN
UPDATE eventsOnceOff SET Time1 = 
CONCAT( LEFT(Time1,4), '2')
ELSEIF (LEFT(Time1,4) = '8') THEN
UPDATE eventsOnceOff SET Time1 = 
CONCAT( LEFT(Time1,4), '7')
ELSE UPDATE eventsOnceOff SET Time1 = 
CONCAT( LEFT(Time1,4), '7')";

$queryUU = "UPDATE eventsOnceOff 
...
$queryUU = "UPDATE eventsOnceOff SET Time1 =CONCAT(
                   REPLACE(
...
$queryUU = "UPDATE eventsOnceOff SET Time1 = 
...
$queryUU = "UPDATE yearlyevents SET Time1 = 
(CONCAT( LEFT(Time1,4), '2')) where (RIGHT(Time1,1) = '0' )";
...
$queryUU = "UPDATE monthlyevents SET Time1 = 
(CONCAT( LEFT(Time1,4), '2')) where (RIGHT(Time1,1) = '0' )";
